    ...
    return (
        ...
        >
          ...
          >
            ...
            <span>{t.hotelDetail.backLink}</span>
          </button>
            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-wrap items-center gap-8 mb-10">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs font-bold text-slate-400 font-sans">{hotel.reviews} {t.hotelDetail.guestReviews}</span>
                        </div>
                    </div>
                ...
                <div className="mt-auto flex flex-col sm:flex-row items-center justify-between gap-6 p-2 lg:p-4 bg-white ring-1 ring-slate-100 rounded-3xl shadow-xl shadow-slate-200/40">
                    <div className="flex flex-col pl-4">
                        <span className="text-[10px] text-slate-400 font-black uppercase tracking-widest mb-1">Total {t.hotelDetail.perNight}</span>
          ...
          <div className="border-t border-slate-100 pt-20">
            <h2 className="text-3xl font-black text-slate-900 mb-10 tracking-tight uppercase tracking-widest text-sm text-center">{t.hotelDetail.includes}</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 border-t border-slate-100 pt-20">
              ...
              <div>
                ...
                <div className="w-full h-[400px] rounded-[2.5rem] overflow-hidden shadow-inner ring-1 ring-slate-200 bg-slate-100 relative group">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 p-4 bg-white/90 backdrop-blur-md rounded-2xl border border-white shadow-xl flex items-center justify-between scale-95 group-hover:scale-100 transition-transform">
                    <div>
                      <span className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">{t.hotelDetail.exactLocation}</span>
            ...
            <div className="space-y-8">
               <div className="bg-brand-950 text-white p-10 rounded-[3rem] shadow-2xl relative overflow-hidden ring-1 ring-white/10">
                  ...
                  <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-brand-400 mb-10">{t.hotelDetail.accommodation}</h3>
                  ...
                  <div className="space-y-10 relative z-10">
                    <div className="flex items-start gap-6">
                       ...
                       <div>
                          <span className="block text-[10px] font-black uppercase tracking-widest text-brand-500 mb-1">{t.hotelDetail.checkIn}</span>
                    ...
                    <div className="flex items-start gap-6">
                       ...
                       <div>
                          <span className="block text-[10px] font-black uppercase tracking-widest text-brand-500 mb-1">{t.hotelDetail.checkOut}</span>
                  ...
                  <div className="mt-16 space-y-4">
                     <span className="block text-[9px] font-black uppercase tracking-widest text-brand-600 mb-6">{t.hotelDetail.policies}</span>
               ...
               <div className="bg-slate-50 p-10 rounded-[3rem] border border-slate-200/60 shadow-inner">
                  <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-8">{t.hotelDetail.concierge}</h3>
